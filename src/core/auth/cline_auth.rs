...
///
/// ```
/// use zeroproxy::core::auth::cline_auth::strip_workos_prefix;
///
...
///
/// ```
/// use zeroproxy::core::auth::cline_auth::validate_cline_token;
///
...
///
/// ```
/// use zeroproxy::core::auth::cline_auth::build_cline_auth_header;
///
